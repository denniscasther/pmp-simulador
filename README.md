...
**CPMAI** trae su propio ECO 2025 —5 dominios, 37 tareas, 266 preguntas: 38 propias que
cubren las 37 tareas, más 228 adaptadas de terceros (ver la excepción más abajo)—
...
node prueba-cpmai.js    # 1720 pruebas · CPMAI
```
...
| `cpmai-adaptadas-2.js` | 109 preguntas · prueba de práctica 2 (faltan las 9 primeras, la 73 y la 110) |
